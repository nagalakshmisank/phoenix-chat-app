...
# Registry: PRZMA.PzDb.WriterRegistry (local ETS-based)

defmodule PRZMA.PzDb.VaultWriter do
  ...
  def queue_depth(did) do
    case Registry.lookup(PRZMA.PzDb.WriterRegistry, did) do
  ...
  defp via(did) do
    {:via, Registry, {PRZMA.PzDb.WriterRegistry, did}}
  end
