...
# Add PRZMA.PzDbV2.Supervisor to your application.ex children list.

defmodule PRZMA.PzDbV2.Supervisor do
  use Supervisor
  ...
  def init(_opts) do
    children = [
      ...
      {Registry, keys: :unique, name: PRZMA.PzDbV2.WriterRegistry},

      # DynamicSupervisor for VaultWriter instances
      {DynamicSupervisor, name: PRZMA.PzDbV2.WriterSupervisor, strategy: :one_for_one},

      # ETS-backed read cache
      PRZMA.PzDbV2.ReadCache,

      # Compaction scheduler — DISABLED for trial 1: needs PzDb.NIF.pzdb_compact/2
      # (doesn't exist yet on the Rust side) and VaultWriter.active_dids/0
      # (not implemented in the enterprise code). Turn on in a later trial.
      # PRZMA.PzDbV2.Compaction,

      # Health monitor and circuit breaker
      PRZMA.PzDbV2.HealthMonitor,

      # Telemetry handler
      {PRZMA.PzDbV2.Telemetry, []},
    ]
...
defmodule PRZMA.PzDbV2.Telemetry do
  @moduledoc """
